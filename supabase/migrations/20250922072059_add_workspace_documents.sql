...
CREATE INDEX IF NOT EXISTS idx_workspace_documents_usage_count ON workspace_documents(usage_count);
...
-- Fonction pour mettre à jour l'usage des documents
CREATE OR REPLACE FUNCTION update_document_usage(doc_id UUID)
RETURNS VOID AS $$
BEGIN
