  ...
  return (
    <div className="w-full mx-auto px-4 sm:px-6 lg:px-[80px]">
      ...
      <main id="main-content" role="main" aria-label="Assistant de décision">
        ...
        {analysisStep === 'idle' && (
          <React.Suspense fallback={<div className="flex items-center justify-center p-8" role="status" aria-label="Chargement en cours">
        ...
        {analysisStep === 'done' && (
          <React.Suspense fallback={<div className="flex items-center justify-center p-8" role="status" aria-label="Chargement des résultats">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div>
