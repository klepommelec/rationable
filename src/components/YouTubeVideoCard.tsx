  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col justify-between flex-1 min-h-0">
        <h4 className="font-medium text-sm text-gray-900 dark:text-white line-clamp-2 mb-3 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors leading-5 min-h-[2.5rem]">
          {video.title}
        </h4>
