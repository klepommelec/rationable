...
const YouTubeVideoCard: React.FC<YouTubeVideoCardProps> = ({ video }) => {
  return (
    <a
      ...
      className="group block h-full min-h-0 bg-white dark:bg-gray-800 rounded-none border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-all duration-200 hover:scale-[1.02] flex flex-col"
    ...
    >
      ...
      <div className="p-4 md:p-4 flex flex-col flex-1 min-h-0">
