...
const AnalysisResult: React.FC<AnalysisResultProps> = ({
  ...
  return <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
      ...
      <Card className="relative overflow-hidden border-gradient-to-r from-gray-50 to-gray-100 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-blue-950 dark:via-slate-900 dark:to-purple-950 dark:border-blue-500/30">
