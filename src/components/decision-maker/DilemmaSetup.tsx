          ...
          <CardContent className="space-y-6 px-4 sm:px-6">
            <div className="space-y-2">
              <div className="relative">
                {/* Wrapper pour les particules flottantes */}
                <div className={`floating-particles-wrapper relative ${isDragOver ? 'drag-active' : ''}`}>
                  <Textarea 
                    id="dilemma-input" 
                    placeholder="" 
                    value={dilemma} 
                    ...
                    onDrop={handleDrop} 
                    className={`focus:ring-cyan-500 text-base md:text-sm h-[160px] resize-none pr-20 transition-colors ${isDragOver ? 'border-primary bg-primary/5 border-2 border-dashed' : ''}`} 
                ...
                <div className="absolute bottom-3 right-3 flex gap-1">
                  ...
                  <button 
                    ...
                    className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed rounded-full"
                  >
                  ...
                  {analysisStep === 'idle' && (
                    <button 
                      ...
                      className="p-2 bg-cyan-500 hover:bg-cyan-600 text-slate-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed rounded-full"
                    >
