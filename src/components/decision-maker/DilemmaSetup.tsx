  ...
  return <div className="max-w-4xl mx-auto space-y-6">
            <Card className="backdrop-blur-sm relative">
                ...
                <CardContent className="space-y-6 px-4 sm:px-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <Textarea id="dilemma-input" placeholder="" value={dilemma} onChange={e => setDilemma(e.target.value)} className="focus:ring-cyan-500 text-base md:text-sm min-h-[100px] resize-none" disabled={isLoading || isUpdating || analysisStep === 'done'} rows={3} aria-describedby="dilemma-help" aria-invalid={dilemma.trim() === '' ? 'true' : 'false'} />
                            {dilemma === '' && <div className="absolute top-3 left-3 pointer-events-none">
                ...
                <CardFooter className="flex flex-col gap-4 px-4 sm:px-6">
                    <MainActionButton analysisStep={analysisStep} handleStartAnalysis={handleStartAnalysis} isMainButtonDisabled={dilemma.trim() === '' || isLoading} progress={progress} progressMessage={progressMessage} />
                </CardFooter>
            </Card>
