                ...
                <TableCell className="max-w-sm">
                  <ul className="text-sm space-y-1">
                    {pros.slice(0, 3).map((pro, i) => (
                      <li key={i} className="text-green-700 text-xs py-[0.5px]">• {pro}</li>
                    ))}
                    {pros.length > 3 && (
                      <li className="text-xs text-muted-foreground">+{pros.length - 3} autre(s)</li>
                    )}
                  </ul>
                </TableCell>
                <TableCell className="max-w-sm">
                  <ul className="text-sm space-y-1">
                    {cons.slice(0, 3).map((con, i) => (
                      <li key={i} className="text-red-700 text-xs py-[0.5px]">• {con}</li>
                    ))}
                    {cons.length > 3 && (
                      <li className="text-xs text-muted-foreground">+{cons.length - 3} autre(s)</li>
                    )}
                  </ul>
                </TableCell>
              </TableRow>
