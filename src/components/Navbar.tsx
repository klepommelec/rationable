...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return <header className={`sticky top-0 z-50 w-full transition-all duration-200 ${isScrolled ? 'bg-white/95 backdrop-blur border-b supports-[backdrop-filter]:bg-white/90' : 'bg-transparent'}`}>
