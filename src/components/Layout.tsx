...
const Layout = () => {
  ...
  return <div className="min-h-screen flex flex-col text-foreground relative bg-black">
      {/* Dégradé uniquement sur la home page et en thème clair */}
      {isHomePage && <div className="absolute top-0 left-0 w-full h-full pointer-events-none dark:hidden" style={{
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main role="main" id="main-content" className={`flex-grow ${isSettingsPage ? 'h-[calc(100vh-4rem)] overflow-hidden' : 'container mx-auto sm:px-6 lg:px-8 sm:py-6 lg:py-8 max-w-full overflow-x-hidden px-[3px] py-0'}`}>
          <Outlet />
        </main>
