...
const Layout = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-background text-foreground relative">
      ...
      <div className="relative z-10">
        ...
        <main role="main" id="main-content" className="flex-grow container mx-auto sm:px-6 lg:px-8 sm:py-6 lg:py-8 max-w-full overflow-x-hidden px-[3px] py-[3px]">
          <Outlet />
        </main>
        <Footer />
      </div>
