...
const fr: UITranslations = {
  ...
  dilemmaSetup: {
    title: "Configuration du dilemme",
    placeholder: "Décrivez votre dilemme...",
    ...
    toast: {
      decisionCreated: "Décision créée avec succès",
    },
    ...
    history: {
      title: "Historique",
      description: "Vos décisions précédentes",
      toasts: {
        templateApplied: "Modèle appliqué avec succès",
        templateError: "Erreur lors de l'application du modèle",
        decisionDeleted: "Décision supprimée",
...
const en: UITranslations = {
  ...
  dilemmaSetup: {
    ...
    toast: {
      decisionCreated: "Decision created successfully",
    },
    ...
    hero: {
      ...
      titleLine2: "Rationable",
      brand: "Rationable",
      subtitle: "From uncertainty to clarity: leverage the power of AI",
    },
    templates: {
    ...
    history: {
      title: "History",
      description: "Your previous decisions",
      toasts: {
